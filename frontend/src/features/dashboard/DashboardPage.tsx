  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex items-center gap-2">
        ...
        <span className="text-gray-500 text-sm">{t('dashboard.vs_last_month')}</span>
      </div>
    </motion.div>
  );
};
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <KpiCard title={t('dashboard.total_users')} value="67.4k" trend="+12%" isPositive={true} icon={Users} />
        <KpiCard title={t('dashboard.revenue')} value="$1.2M" trend="+24%" isPositive={true} icon={DollarSign} />
        <KpiCard title={t('dashboard.active_projects')} value="815" trend="-3%" isPositive={false} icon={Briefcase} />
        <KpiCard title={t('dashboard.conv_rate')} value="4.8%" trend="+7%" isPositive={true} icon={Activity} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 glass-card p-8">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-xl font-semibold">{t('dashboard.performance')}</h3>
